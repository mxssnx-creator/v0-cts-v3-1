...
import { Activity, TrendingUp, BarChart3, Settings, RefreshCw, AlertTriangle, Zap } from "lucide-react"
  ...
  return (
    <AuthGuard>
      <div className="flex flex-col h-screen">
        <PageHeader
          title="Indications"
          description="View and manage trading indications across all connections"
          icon={Zap}
          actions={
