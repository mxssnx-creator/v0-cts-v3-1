...
export interface ConnectionRow extends DatabaseRow {
  id: string
  name: string
  exchange: string
  exchange_id?: number
...
export interface PositionRow extends DatabaseRow {
  id: string
  connection_id: string
  symbol: string
  side: string
...
export interface LogRow extends DatabaseRow {
  id: string
  level: string
  category: string
  message: string
...
export interface PresetCoordinationStatus {
  running: boolean
  paused: boolean
  testing_progress: number
  tested_configs: number
...
export interface ActiveIndicationResponse {
  direction: boolean
  move: boolean
  active: boolean
  optimal: boolean
  active_advanced: boolean
}

export interface PresetTypeResponse {
  id: string
  name: string
  description?: string
  is_active: boolean
